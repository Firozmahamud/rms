...
getAllReservation: function(callback) {
    ...
    insertReservation: function(data, callback) {
        var sql = "insert into reservation_details values(?,?,?,?,?,?)";
        db.execute(sql, ["",
            data.u_id,
    ...
    deleteReservation: function(id, callback) {
        var sql = "delete from reservation_details where f_id=?";
        db.execute(sql, [id], function(status) {
            if (status) {
                callback(true);
            } else {
    ...
    //     var sql = "insert into contact values(null,?,?)";
    //     db.execute(sql, [
    //         data.email, 
    //         data.message
    //         ], function(status) {
